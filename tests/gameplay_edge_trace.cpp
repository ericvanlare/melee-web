...
int main(int argc,char** argv){try{
 ...
 check(argc==2||phase_only,"Expected local asset directory or 'phase' variant");RuntimeFiles files;
 ...
 bool lost=false,second=false,first_edge=false,first_cross=false;int stock=4,first_post_frames=0,second_frame=0,phase_frames=0;
