  ...
  await mountMeleeRuntime({canvas:$('canvas'),loaderUrl:new URL('./gameplay_menu_browser.js',import.meta.url),
    ...
    configureModule(module){
      installRuntimeCache(module,report=>{const size=report.fileBytes?` · ${report.fileBytes} persisted bytes`:'';
        $('cache-status').textContent=report.message+size;$('export-render-cache').disabled=!report.mounted||!report.populated;
      ...
      },{clearOnLoad:clearRenderCacheOnLoad});
    },
    onState(state){
