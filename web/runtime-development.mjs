...
$('retail-replay-start').onclick=async()=>{
 ...
 try{
  ...
  const file=$('retail-replay-file').files[0];if(!file||file.size<328||file.size>1585194)throw Error('Invalid bounded MWRC input recipe');
