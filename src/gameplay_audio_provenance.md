...
The4096-byte coefficient input is supplied separately; it is never inferred from
an SSM and no coefficient binary is tracked. The local proof uses the reference
Dolphin application's free replacement DROM, SHA256
