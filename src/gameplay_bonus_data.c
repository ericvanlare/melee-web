...
struct MeleeWebBonusData {pl_804D6470_t values;pl_804D6470_t* previous;};
...
int melee_web_bonus_data_end(MeleeWebBonusData* data,char* e,size_t n){
    if(!melee_web_bonus_data_ready(data))return fail(e,n,"Bonus threshold publication is not owned by this scope");
