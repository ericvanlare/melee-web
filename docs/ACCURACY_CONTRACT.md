...
| --- | --- | --- |
| HTML CSS/SSS | HTML exercises configuration and teardown; original menu descriptors and neutral SSS callbacks pass, with no rendered menu flow | Execute and compare original menus and transitions; remove HTML player selection |
